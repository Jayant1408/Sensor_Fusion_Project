...
# show_only_frames = [0, 200] # show only frames in interval for debugging original
show_only_frames = [0,1] # show only frames in interval for debugging MTP1
# show_only_frames = [0, 1] # show only frames in interval for debugging MTP2
# show_only_frames = [50, 51] # show only frames in interval for debugging MTP3
# show_only_frames = [50, 150] # show only frames in interval for debugging MTP4
...
exec_tracking = []
exec_visualization = ['show_objects_in_bev_labels_in_camera', 'show_pcl']
# exec_visualization = ['bev_from_pcl']
...
# # exec_data = [] #MTP1
# # exec_data = ['pcl_from_rangeimage'] #MTP2
# exec_data = ['pcl_from_rangeimage', 'load_image']  #MTP3
# # exec_detection = [] #MTP1
# # exec_detection = ['bev_from_pcl']  #MTP2
# exec_detection = ['bev_from_pcl', 'detect_objects']  #MTP3
# exec_tracking = []
# # exec_visualization = ['show_range_image'] #MTP1
# # exec_visualization = ['show_pcl'] #MTP2
# exec_visualization = ['show_objects_in_bev_labels_in_camera'] #MTP3
# configs_det = det.load_configs(model_name="fpn_resnet") #MTP3
...
# exec_detection = ['bev_from_pcl', 'detect_objects', 'validate_object_labels', 'measure_detection_performance'] # options are 'bev_from_pcl', 'detect_objects', 'validate_object_labels', 'measure_detection_performance'; options not in the list will be loaded from file original
# exec_tracking = [] # options are 'perform_tracking' original
# exec_visualization = [] # options are 'show_range_image', 'show_bev', 'show_pcl', 'show_labels_in_image', 'show_objects_and_labels_in_bev', 'show_objects_in_bev_labels_in_camera', 'show_tracks', 'show_detection_performance', 'make_tracking_movie' orignal 
